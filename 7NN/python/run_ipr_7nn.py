"""
Calculate the typical inverse participation ratio for the 7NN lattice.
...
The parameters below are currently small test values. We will replace
them with the actual production parameters after confirming that the
...
# ======================================================
def main() -> None:
    """Run the 7NN IPR calculation and save the results."""
