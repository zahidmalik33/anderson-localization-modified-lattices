"""
Calculate the mean consecutive level-spacing ratio for the 8NN lattice.
...
The parameters below are small test values.
"""
...
# ======================================================
def main() -> None:
    """Run the 8NN level-spacing calculation."""
    ...
    for lattice_size in SYSTEM_SIZES:
        ...
        output_file = (
            output_directory
            / f"level_spacing_8nn_L{lattice_size}.csv"
        )
